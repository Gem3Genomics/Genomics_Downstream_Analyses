...
Demographic history in often investigated by applying SMC (Pairwise Sequential Markovian Coalescent) analysis. To read more about the PSMC software we will use or to download, visit [PSMC](https://github.com/lh3/psmc/tree/master).
